...
use esp_idf_sys::{
    CONFIG_LWIP_SNTP_MAX_SERVERS, ESP_ERR_INVALID_ARG, esp_err_t, esp_netif_sntp_init,
...
pub extern "C" fn rust_sntp_init(ip_event_to_renew: u32) -> esp_err_t {
    ...
    unsafe { esp_netif_sntp_init(&raw const sntp_config) }
}
